...
public class Lista_Donantes 
{
    ...
    public Lista_Donantes(String donantes) 
    {
        ...
        cargarDonantes(donantes); //SE LLAMA AL MÉTODO cargarDonantes PARA CARGAR LOS DATOS DE LOS DONANTES DESDE UN ARCHIVO CUYO NOMBRE SE PASA COMO ARGUMENTO AL CONSTRUCTOR.   
    }
